...
from nlotrajectories.core.dynamics import PointMass1stOrder, PointMass2ndOrder, Unicycle
from nlotrajectories.core.geometry import DotGeometry, RectangleGeometry, TriangleGeometry, GoalMode
...
def main(config_path):
    ...
    plot_trajectory(X_opt, geometry, title="Benchmark 1", goal=cfg["body"]["goal_state"], obstacle_draw_fn=draw_obstacle, cfg=cfg)
